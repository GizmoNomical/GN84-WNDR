...
local distributionTableLottoTickets = {
    all = {
        inventoryfemale = {
            rolls = 1,
            items = {
                "GN84-WND.LottoTicketStandard", 7,
                "GN84-WND.LottoTicketRare", 0.000001,
            }
        },
        inventorymale = {
            rolls = 2,
        ...
        cashregister = {
            rolls = 50,
            items = {                     
                "GN84-WND.LottoTicketStandard", 45,   
                "GN84-WND.LottoTicketRare", 0.0000001,         
            }
        },
    },
}
...
table.insert(ProceduralDistributions["list"]["BedroomSideTable"].items, "GN84-WND.LottoTicketStandard");
table.insert(ProceduralDistributions["list"]["BedroomSideTable"].items, 10);

table.insert(ProceduralDistributions["list"]["BedroomSideTable"].items, "GN84-WND.LottoTicketRare");
...
table.insert(ProceduralDistributions["list"]["BedroomDresser"].items, "GN84-WND.LottoTicketStandard");
table.insert(ProceduralDistributions["list"]["BedroomDresser"].items, 10);

table.insert(ProceduralDistributions["list"]["BedroomDresser"].items, "GN84-WND.LottoTicketRare");
...
table.insert(ProceduralDistributions["list"]["BarCounterMisc"].items, "GN84-WND.LottoTicketStandard");
table.insert(ProceduralDistributions["list"]["BarCounterMisc"].items, 25);

table.insert(ProceduralDistributions["list"]["BarCounterMisc"].items, "GN84-WND.LottoTicketRare");
...
table.insert(VehicleDistributions["GloveBox"].items, "GN84-WND.LottoTicketStandard");
table.insert(VehicleDistributions["GloveBox"].items, 0.5);


table.insert(ProceduralDistributions.list["BinBar"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["BinBar"].items, 5)


table.insert(ProceduralDistributions.list["BinDumpster"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["BinDumpster"].items, 5)


table.insert(ProceduralDistributions.list["BinGeneric"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["BinGeneric"].items, 5)


table.insert(ProceduralDistributions.list["GunStoreCounter"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["GunStoreCounter"].items, 25)


table.insert(ProceduralDistributions.list["JanitorCleaning"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["JanitorCleaning"].items, 5)


table.insert(ProceduralDistributions.list["JunkBin"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["JunkBin"].items, 5)


table.insert(ProceduralDistributions.list["LivingRoomShelf"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["LivingRoomShelf"].items, 10)


table.insert(ProceduralDistributions.list["LivingRoomSideTable"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["LivingRoomSideTable"].items, 10)


table.insert(ProceduralDistributions.list["OfficeDeskHome"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["OfficeDeskHome"].items, 10)


table.insert(ProceduralDistributions.list["OtherGeneric"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["OtherGeneric"].items, 10)


table.insert(ProceduralDistributions.list["RandomFiller"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["RandomFiller"].items, 10)


table.insert(ProceduralDistributions.list["ShelfGeneric"].items, "GN84-WND.LottoTicketStandard")
table.insert(ProceduralDistributions.list["ShelfGeneric"].items, 10)


table.insert(ProceduralDistributions.list["CrateCigarettes"].items, "GN84-WND.LottoTicketStandard")
